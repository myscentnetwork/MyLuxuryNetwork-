...
// GET /api/reseller/[id]/products - Get reseller's imported products
...
// POST /api/reseller/[id]/products - Import a product
export async function POST(
  ...
  try {
    ...
    const basePrice = product.resellerPrice || product.wholesalePrice;
    ...
    // Create the import
    const imported = await prisma.resellerProduct.create({
      data: {
        resellerId: id,
        productId: productId,
    ...
    return NextResponse.json({
      ...
      product: {
        ...
        product: {
          ...
          resellerPrice: imported.product.resellerPrice,
