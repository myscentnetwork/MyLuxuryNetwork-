...
// GET /api/wholesaler/[id]/products - Get wholesaler's imported products
...
// POST /api/wholesaler/[id]/products - Import a product
export async function POST(
  ...
  try {
    ...
    const existing = await prisma.wholesalerProduct.findUnique({
      where: {
    ...
    return NextResponse.json({
      ...
      product: {
        ...
        product: {
          ...
          wholesalePrice: imported.product.wholesalePrice,
