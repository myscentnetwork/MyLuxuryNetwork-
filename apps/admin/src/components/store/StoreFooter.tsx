...
export default function StoreFooter({
  ...
  return (
    <footer className="bg-luxury-dark border-t border-luxury-gray/30 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Premium luxury products curated with excellence. Authenticity
